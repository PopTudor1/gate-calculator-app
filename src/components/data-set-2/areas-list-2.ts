...
import Area1, { area1GateTypesInput, area1RunesInput } from "./area1/area-1";
import Area2, { area2GateTypesInput, area2RunesInput } from "./area2/area-2";
